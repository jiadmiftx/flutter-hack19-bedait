          ...
          SliverAppBar(
            ...
            ListView(
              ...
              children: <Widget>[
                ...
                Text("Bedait Berbagi Berkarya", textAlign: TextAlign.center,style: TextStyle(
                  color: Colors.white,
                ...
                Stack(
                  children: <Widget>[
                    ...
                    Positioned(
                      right: 10,
                      top: 10,
                      child: Icon(Icons.favorite, color: Colors.grey.shade800,size: 28.0,),
                    ),
                    Positioned(
                      right: 8,
                      top: 8,
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 5.0,),
                          Text(room['location'], style: TextStyle(color: Colors.black),)
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 5.0,),
                          Text(room['member']+" People", style: TextStyle(color: Colors.black),)
                        ],
                      )
                    ],   
                  ),
